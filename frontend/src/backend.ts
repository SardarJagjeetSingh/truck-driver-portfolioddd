...
import type { Inquiry as _Inquiry, ServiceInterest as _ServiceInterest, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async findInquiriesByName(arg0: string): Promise<Array<Inquiry>> {
        if (this.processError) {
            try {
                const result = await this.actor.findInquiriesByName(arg0);
    ...
    async submitInquiry(arg0: string, arg1: string, arg2: string | null, arg3: ServiceInterest, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitInquiry(arg0, arg1, to_candid_opt_n12(this._uploadFile, this._downloadFile, arg2), to_candid_ServiceInterest_n13(this._uploadFile, this._downloadFile, arg3), arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_ServiceInterest_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ServiceInterest): ServiceInterest {
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        serviceInterest: from_candid_ServiceInterest_n7(_uploadFile, _downloadFile, value.serviceInterest),
...
function from_candid_variant_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    websiteBuilding: null;
}): ServiceInterest {
    return "hostingAndDomain" in value ? ServiceInterest.hostingAndDomain : "softwareDevelopment" in value ? ServiceInterest.softwareDevelopment : "itConsulting" in value ? ServiceInterest.itConsulting : "aiAutomation" in value ? ServiceInterest.aiAutomation : "websiteBuilding" in value ? ServiceInterest.websiteBuilding : value;
}
...
function to_candid_ServiceInterest_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ServiceInterest): _ServiceInterest {
...
function to_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ServiceInterest): {
    hostingAndDomain: null;
} | {
    softwareDevelopment: null;
} | {
    ...
    return value == ServiceInterest.hostingAndDomain ? {
        hostingAndDomain: null
    } : value == ServiceInterest.softwareDevelopment ? {
        softwareDevelopment: null
    } : value == ServiceInterest.itConsulting ? {
        itConsulting: null
    } : value == ServiceInterest.aiAutomation ? {
        aiAutomation: null
    } : value == ServiceInterest.websiteBuilding ? {
        websiteBuilding: null
    } : value;
}
